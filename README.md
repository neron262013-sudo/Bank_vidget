...
12. Форматирует csv файлы в список словарей с данными. (databases_readers)
- В аргументе путь к csv файлу в формате "data/file_name.csv"
```
print(get_from_csv("data/transactions.csv"))
```

13. Форматирует xlsx файлы в список словарей с данными. (databases_readers)
- В аргументе путь к xlsx файлу в формате "data/file_name.xlsx"
```
print(get_form_xlsx("data/transactions_excel.xlsx"))
```

14. Поиск строки в списке словарей с операциями. (processing)
```
...
15. Подсчитывает количество операций по типу из данных по операциям. (processing)
- Принимает список словарей с операциями и список с описанием операций.
- Описания хранятся в description
```
print(process_bank_operations([{"description": "Перевод организации"},
                               {"description": "Перевод организации"},
...
16. Функция main, которая отвечает за основную логику проекта с пользователем и связывает функциональности между собой.
- Общается с пользователем и предлагает выбрать файл сортировки и тип операции
- позволяет отсортировать по дате, валюте и слову
```
# Запуск в консоли
python main.py
```
