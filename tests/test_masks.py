...
@pytest.mark.parametrize("card_number", [(123456789.1234567),
                                         ([1234, 5678, 9123, 4567]),
                                         ("1234567891234567")])
...
@pytest.mark.parametrize("account_number", [(123451234512345.12345),
                                         ([1234, 5678, 1234, 5678]),
                                         ("12345123451234512345")])
def test_get_mask_card_number_wrong_types(account_number):
    with pytest.raises(ValueError):
        get_mask_account(account_number)
